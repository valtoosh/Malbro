...
import { PageShell, Card, BountyCard, Button, ChevronDivider } from '@marlbro/ui';
    ...
    <PageShell>
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7">
          <Card
            variant="poster"
            className="aspect-[4/5] flex items-center justify-center bg-marlbro halftone-overlay relative"
          >
      ...
      <section className="mt-20 bg-ink text-paper p-12 border-4 border-ink shadow-lg">
        ...
        <ol className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 list-none">
          <li>
            <p className="font-mono text-caption uppercase tracking-[0.12em] text-paper/60">
              STEP 1
            </p>
