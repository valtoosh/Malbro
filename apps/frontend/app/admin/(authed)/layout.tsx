// apps/frontend/app/admin/(authed)/layout.tsx
import { redirect } from 'next/navigation';
import { cookies } from 'next/headers';
import { decodeSession, type SessionPayload } from '@marlbro/shared/session';
...
function AdminFrame({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-paper">
      ...
      <main className="flex-1 max-w-[1280px] w-full mx-auto px-8 md:px-12 py-10">
        {children}
      </main>
    </div>
  );
