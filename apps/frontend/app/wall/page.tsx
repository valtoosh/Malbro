// apps/frontend/app/wall/page.tsx
import Link from 'next/link';
import { PageShell, PosterCard } from '@marlbro/ui';
import { SAMPLE_POSTERS } from '@marlbro/shared/sampleData';
...
export default async function WallPage() {
  let posters: PosterGrant[] = SAMPLE_POSTERS as PosterGrant[];
  try {
    const data = await backendJson<{ posters: PosterGrant[] }>('/wall');
